...
function get_categories() {
    ...
    const endPonint = 'http://mybsaletest.000webhostapp.com/api/get_category';
...
function categories(id_category,page,id_element,filtro){
    ...
    const endPonint = 'http://mybsaletest.000webhostapp.com/api/order_product_category?id_category='+localStorage.getItem('id_category_old')+'&page='+page+'&filtro='+localStorage.getItem('ifiltro_old');
    request.open('GET',endPonint,true);
    request.send();
    var content=''
    request.onreadystatechange = function(){
